...
<template>
    <div>
        <div v-if="!props.plans || props.plans.length === 0" class="text-center py-6">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    <tr v-for="plan in plans" :key="plan.id">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                    {{ plan.name }}
                                    <span v-if="plan.is_featured" class="ml-2 px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                        Featured
                                    </span>
                                </div>
                            </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button @click="editPlan(plan)" class="text-blue-600 hover:text-blue-900 mr-3">
                                Edit
                            </button>
