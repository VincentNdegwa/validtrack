  ...
  <Card class="h-full shadow-md hover:shadow-lg transition-shadow duration-300">
    <CardHeader class="pb-2 border-b">
      <CardTitle class="flex items-center space-x-2">
        <span class="inline-block w-2 h-6 bg-gradient-to-b from-amber-500 to-red-500 rounded-sm mr-2"></span>
    ...
    <CardContent class="pt-4">
      <div class="h-80">
        <Line 
          ...
          aria-label="Document expiry timeline chart"
        />
      </div>
      <div class="mt-4 flex justify-center gap-6 text-xs text-muted-foreground">
        <div class="flex items-center">
          <span class="inline-block w-3 h-3 bg-red-500 opacity-70 rounded-sm mr-1"></span>
          <span>Critical Expiry (&lt;7 days)</span>
        </div>
        <div class="flex items-center">
          <span class="inline-block w-3 h-3 bg-amber-500 opacity-30 rounded-sm mr-1"></span>
