    ...
    <Card class="h-full shadow-md transition-shadow duration-300 hover:shadow-lg">
        <CardHeader class="border-b pb-2">
            <CardTitle class="flex items-center space-x-2">
                <span class="mr-2 inline-block h-6 w-2 rounded-sm bg-gradient-to-b from-green-500 to-amber-500"></span>
                <span>Subject Compliance</span>
            </CardTitle>
        </CardHeader>
        <CardContent class="pt-4">
            <div style="height: 400px">
                <Bar :data="chartData" :options="chartOptions as any" aria-label="Subject compliance chart" />
            </div>
            <div class="mt-4 flex justify-center gap-6 text-xs text-muted-foreground">
                <div class="flex items-center">
                    <span class="mr-1 inline-block h-3 w-3 rounded-sm bg-emerald-500 opacity-80"></span>
                    <span>Active Documents</span>
                </div>
                <div class="flex items-center">
                    <span class="mr-1 inline-block h-3 w-3 rounded-sm bg-amber-500 opacity-80"></span>
