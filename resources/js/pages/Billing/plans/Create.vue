                ...
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center">
                                            <template v-if="feature.type === 'boolean'">
                                                <Switch :id="`feature-${feature.id}`" v-model="form.features[feature.id]" />
                                            </template>
                                            ...
                                            <template v-else>
                                                <Input :id="`feature-${feature.id}`" v-model="form.features[feature.id]" />
                                            </template>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="flex justify-end space-x-2">
                            ...
                            <Button type="submit" :disabled="form.processing" class="bg-primary text-primary-foreground"> Create Plan </Button>
                        </div>
                    </form>
                </CardContent>
            </Card>
