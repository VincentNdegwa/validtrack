...
const features = ref([
    ...
    },
    {
        ...
        description: 'Get notified before documents expire via email. Set reminder days (e.g. 30, 14, 7, 1 days) and stay ahead of compliance deadlines',
    ...
    <div class="flex min-h-screen flex-col bg-background text-foreground">
        ...
        <header class="sticky top-0 z-40 w-full border-b border-border/40 bg-background/80 backdrop-blur-sm">
            <div class="container mx-auto flex items-center justify-between px-4 py-4">
                <div class="flex items-center gap-2">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" class="h-6 w-6 text-white" stroke-linecap="round" stroke-linejoin="round">
                ...
                <nav class="hidden items-center space-x-5 md:flex">
                    <a href="#features"
                        class="text-sm font-medium text-foreground/80 transition-colors hover:text-primary">Features</a>
                    <a href="#demo"
                        class="text-sm font-medium text-foreground/80 transition-colors hover:text-primary">Demo</a>
                    <a href="#use-cases"
                        class="text-sm font-medium text-foreground/80 transition-colors hover:text-primary">Use
                        Cases</a>
                    <a href="#pricing"
                        class="text-sm font-medium text-foreground/80 transition-colors hover:text-primary">Pricing</a>
                    <a href="#faq"
                        class="text-sm font-medium text-foreground/80 transition-colors hover:text-primary">FAQ</a>
                    <a href="#testimonials"
                        class="text-sm font-medium text-foreground/80 transition-colors hover:text-primary">Testimonials</a>
                </nav>
        ...
        <section class="relative overflow-hidden pt-24 pb-20 md:pt-32 md:pb-28">
            ...
            <div class="container mx-auto px-4">
                <div class="flex max-w-7xl justify-self-center flex-col items-center gap-12 md:flex-row">
                    <div class="space-y-8 md:w-1/2">
                        <div
                            :class="['translate-y-4 opacity-0 transition-all duration-700', { 'translate-y-0 opacity-100': loaded }]">
                            <span
                                class="inline-flex items-center rounded-full bg-accent/20 px-3 py-1 text-sm font-medium text-accent-foreground">
                        ...
                        <p :class="[
                            ...
                            ValidTrack's comprehensive document management platform combines universal tracking,
                            automated reminders, and robust
                    ...
                    <div
                        :class="['md:absolute md:right-0 translate-x-4 opacity-0 transition-all delay-300 duration-700 md:w-1/2', { 'translate-x-0 opacity-100': loaded }]">
                        <div
                            class="relative overflow-hidden rounded-xl border border-border shadow-2xl shadow-primary/10">
                            <div
                                class="absolute inset-0 bg-gradient-to-tr from-primary/10 to-accent/10 mix-blend-overlay">
                            </div>
                            <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop"
                                alt="ValidTrack Dashboard" class="relative z-10 aspect-[16/9] w-full object-cover" />
                            ...
                            <div
                                ...
                                <div class="flex items-start gap-3">
                                    <div
                                        class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-primary/20 text-primary">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-xs text-muted-foreground">Vendor "TechSupply Inc." has a
                                            document expiring in 14 days.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="py-16">
            <div class="container mx-auto px-4">
                <div class="grid max-w-6xl justify-self-center  grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    <!-- Benefit 1 -->
                    <div
        ...
        <section class="bg-primary/5 py-16">
            <div class="container mx-auto px-4">
                <div class="mx-auto max-w-3xl text-center">
                    <h2 class="mb-8 text-3xl font-bold tracking-tight md:text-4xl">Managing compliance manually is
                        messy, risky, and time-consuming</h2>

                    <div class="mb-10 grid gap-6 md:grid-cols-3">
                        <div class="rounded-lg border border-border bg-card p-6 shadow-sm">
                            <div
                                class="mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-red-100 text-red-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <div class="rounded-lg border border-border bg-card p-6 shadow-sm">
                            <div
                                class="mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-amber-100 text-amber-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="h-6 w-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <section id="features" class="relative py-24 overflow-hidden">
            ...
            <div class="container relative z-10 mx-auto px-4">
                <div class="mb-16 text-center">
                    <span
                        class="mb-4 inline-flex items-center gap-1 rounded-full bg-primary/20 px-3 py-1 text-sm font-medium text-primary">
                    ...
                    <h2 class="mb-4 text-3xl font-bold tracking-tight md:text-4xl lg:text-5xl">
                        Everything You Need For <span
                            class="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Document
                            Compliance</span>
                    </h2>
                ...
                <div class="grid justify-self-center max-w-6xl gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <!-- Feature cards with images -->
                    <div v-for="(feature, index) in features" :key="index" class="reveal-element" :class="[
                            'group relative overflow-hidden rounded-2xl border border-border/50 bg-card/80 p-6 opacity-0 transition-all duration-700 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/10 transform hover:-translate-y-1',
                            { 'opacity-100 is-visible': loaded }
                        ]" :style="{ transitionDelay: `${400 + (index % 6) * 100}ms` }">
                        <!-- Animated glow effect -->
                        <div class="absolute transition-all duration-700 ease-in-out" :class="[
                                index % 2 === 0 ? '-right-16 -top-16 group-hover:-right-8 group-hover:-top-8' : 
                                '-left-16 -bottom-16 group-hover:-left-8 group-hover:-bottom-8',
                                'h-40 w-40 rounded-full bg-' + (index % 2 === 0 ? 'primary' : 'accent') + '/10 blur-3xl'
                            ]">
                        </div>
                        ...
                        <div class="relative z-10">
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="1.5" class="h-8 w-8 text-primary"
                            ...
                            <div class="mb-4 aspect-[16/9] overflow-hidden rounded-lg bg-muted relative">
                                <!-- Overlay gradient on hover -->
                                <div
                                    class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10 flex items-end">
                                    <div class="p-4 text-white">
                                        <span class="text-sm font-medium">View details</span>
                                    </div>
                                </div>
                                <img :src="feature.image || 'https://images.unsplash.com/photo-1568992688065-536aad8a12f6?q=80&w=2832&auto=format&fit=crop'"
                            ...
                            <h3
                                class="mb-2 text-xl font-semibold group-hover:text-primary transition-colors duration-300">
                                {{ feature.title }}</h3>
                            <p class="text-muted-foreground">{{ feature.description }}</p>

                            <!-- Learn more link with enhanced animation -->
                            <div
                                class="mt-4 flex items-center gap-2 text-sm font-medium text-primary relative overflow-hidden group-hover:text-accent transition-colors duration-300">
                                <span class="relative">
                                    Learn more
                                    <span
                                        class="absolute bottom-0 left-0 w-0 h-0.5 bg-primary group-hover:w-full transition-all duration-300 group-hover:bg-accent"></span>
                                </span>
        ...
        <section id="demo" class="relative py-24 overflow-hidden">
            <!-- Futuristic background elements -->
            <div class="absolute inset-0 bg-gradient-to-br from-primary/5 via-background to-accent/5"></div>
            <div class="absolute inset-0 bg-grid-pattern opacity-[0.04]"></div>
            <div class="absolute top-0 left-0 w-full h-64 bg-gradient-to-b from-primary/10 to-transparent blur-3xl">
            </div>
            ...
            <div class="container relative z-10 mx-auto px-4">
                <div class="mb-16 text-center">
                    ...
                    <h2 class="mb-4 text-3xl font-bold tracking-tight md:text-4xl lg:text-5xl">Experience <span
                            class="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Next-Gen</span>
                        Compliance Management</h2>
                    <p class="mx-auto max-w-2xl text-lg text-muted-foreground">
                        Our intuitive interface turns complex compliance processes into simple, visual workflows. See it
                        in action.
                    </p>
                </div>
                ...
                <div class="mx-auto max-w-6xl">
                    ...
                    <div class="mb-8 flex flex-wrap justify-center gap-4">
                        <button
                            class="rounded-full bg-primary px-6 py-2 text-sm font-medium text-primary-foreground transition-all hover:shadow-lg hover:shadow-primary/20">Dashboard</button>
                        <button
                            class="rounded-full bg-card px-6 py-2 text-sm font-medium text-foreground transition-all hover:bg-primary hover:text-primary-foreground">Document
                            Manager</button>
                        <button
                            class="rounded-full bg-card px-6 py-2 text-sm font-medium text-foreground transition-all hover:bg-primary hover:text-primary-foreground">Reports
                            & Analytics</button>
                    </div>
                            ...
                            <div class="flex items-center gap-6">
                                <div class="flex items-center gap-2">
                                    <div
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="2" class="h-4 w-4 text-white">
                                            <path d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                        </svg>
                                    </div>
                            ...
                            <div class="col-span-4 lg:col-span-3">
                                <div class="grid gap-6">
                                    ...
                                    <div class="rounded-xl border border-border bg-background p-4">
                                        ...
                                        <div
                                            class="h-64 w-full bg-gradient-to-r from-primary/10 via-transparent to-accent/10 rounded-lg flex items-end p-4">
                                            <!-- Mock chart bars -->
                                            <div class="flex-1 flex items-end justify-around gap-2 h-full">
                                                <div class="w-6 bg-primary rounded-t-md" style="height: 60%"></div>
                                                <div class="w-6 bg-primary rounded-t-md" style="height: 75%"></div>
                                                <div class="w-6 bg-primary rounded-t-md" style="height: 85%"></div>
                                                <div class="w-6 bg-primary rounded-t-md" style="height: 65%"></div>
                                                <div class="w-6 bg-amber-500 rounded-t-md" style="height: 45%"></div>
                                                <div class="w-6 bg-primary rounded-t-md" style="height: 80%"></div>
                                                <div class="w-6 bg-primary rounded-t-md" style="height: 90%"></div>
                                                <div class="w-6 bg-primary rounded-t-md" style="height: 70%"></div>
                                                <div class="w-6 bg-amber-500 rounded-t-md" style="height: 50%"></div>
                                                <div class="w-6 bg-red-500 rounded-t-md" style="height: 30%"></div>
                                                <div class="w-6 bg-primary rounded-t-md" style="height: 75%"></div>
                                                <div class="w-6 bg-primary rounded-t-md" style="height: 85%"></div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="flex items-center gap-3 rounded-lg p-2 hover:bg-muted/50">
                                                ...
                                                <div class="flex-1">
                                                    <div class="flex items-center justify-between">
                                                        <p class="text-sm font-medium">Insurance certificate uploaded
                                                        </p>
                                                        <span class="text-xs text-muted-foreground">2 hours ago</span>
                                                    </div>
                                                    <p class="text-xs text-muted-foreground">TechSupply Inc. - Expires
                                                        July 15, 2026</p>
                                                </div>
                                            </div>
                                            <div class="flex items-center gap-3 rounded-lg p-2 hover:bg-muted/50">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <p class="text-xs text-muted-foreground">Employee ID 10234 - Expires
                                                        in 14 days</p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
                        <div class="flex justify-center">
                            <div
                                class="animate-pulse flex h-14 w-14 items-center justify-center rounded-full bg-primary/20">
                        ...
                        <div class="flex justify-center">
                            <div class="flex h-14 w-14 items-center justify-center rounded-full bg-accent/10">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" class="h-6 w-6 text-accent">
                                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <section id="use-cases" class="bg-accent/5 py-24">
            <div class="container mx-auto px-4">
                <div class="mb-16 text-center">
                    <span
                        class="mb-4 inline-block rounded-full bg-primary/20 px-3 py-1 text-sm font-medium text-primary">Use
                        Cases</span>
                    <h2 class="mb-4 text-3xl font-bold tracking-tight md:text-4xl">Tailored Solutions for Every Need
                    </h2>
                    <p class="mx-auto max-w-2xl text-lg text-muted-foreground">
                        ValidTrack adapts to your specific compliance and documentation requirements across multiple
                        industries.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div v-for="(useCase, index) in useCases" :key="index"
                        ...
                        <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="1.5" class="h-6 w-6 text-primary"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path :d="useCase.icon" />
                            </svg>
                        </div>
        ...
        <section class="py-24">
            <div class="container mx-auto px-4">
                <div class="mb-16 text-center">
                    <span
                        class="mb-4 inline-block rounded-full bg-primary/20 px-3 py-1 text-sm font-medium text-primary">Target
                        Personas</span>
                    <h2 class="mb-4 text-3xl font-bold tracking-tight md:text-4xl">Perfect for HR, Procurement,
                        Compliance, and Operations Teams</h2>
                    <p class="mx-auto max-w-2xl text-lg text-muted-foreground">
                        ValidTrack adapts to your team's specific document tracking needs across departments and
                        industries.
                    </p>
                </div>
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                <tr class="border-b border-border">
                                    ...
                                    <td class="p-4">Track employee IDs, contracts, training certifications, and
                                        background checks</td>
                                </tr>
                                <tr class="border-b border-border bg-muted/20">
                                    <td class="p-4 font-medium">Procurement</td>
                                    <td class="p-4">Manage vendor tax documents, insurance certificates, and business
                                        registrations</td>
                                </tr>
                                <tr class="border-b border-border">
                                    <td class="p-4 font-medium">Asset Manager</td>
                                    <td class="p-4">Monitor inspection certificates, maintenance records, and equipment
                                        calibrations</td>
                                </tr>
                                <tr class="bg-muted/20">
                                    <td class="p-4 font-medium">NGOs/Partners</td>
                                    <td class="p-4">Handle partnership agreements, grant documents, and compliance
                                        requirements</td>
                                </tr>
                            </tbody>
                        </table>
        ...
        <section id="stats" class="py-24">
            <div class="container mx-auto px-4">
                <div class="mb-16 text-center">
                    <span
                        class="mb-4 inline-block rounded-full bg-primary/20 px-3 py-1 text-sm font-medium text-primary">Results</span>
        ...
        <section id="testimonials" class="bg-primary/5 py-24">
            <div class="container mx-auto px-4">
                <div class="mb-16 text-center">
                    <span
                        class="mb-4 inline-block rounded-full bg-primary/20 px-3 py-1 text-sm font-medium text-primary">Testimonials</span>
                    ...
                    <div v-for="(testimonial, index) in testimonials" :key="index"
                        ...
                        <div class="mb-4 flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-muted-foreground">{{ testimonial.role }}, {{ testimonial.company
                                    }}</p>
                            </div>
                        </div>
        ...
        <section id="faq" class="bg-muted/20 py-24">
            <div class="container mx-auto px-4">
                <div class="mb-16 text-center">
                    <span
                        class="mb-4 inline-block rounded-full bg-primary/20 px-3 py-1 text-sm font-medium text-primary">FAQ</span>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="rounded-lg border border-border bg-card">
                            ...
                            <div class="border-t border-border p-4">
                                <p>Yes! ValidTrack is designed to manage documents for any entity type. You can create
                                    custom subject types like "Employee", "Vendor", "Asset", or any other category
                                    specific to your organization's needs.</p>
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border border-border bg-card">
                            ...
                            <div class="border-t border-border p-4">
                                <p>Absolutely! Our automated notification system allows you to set custom reminder
                                    periods (30, 14, 7, 1 days before expiry) and will send email alerts to designated
                                    team members to ensure you never miss a compliance deadline.</p>
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border border-border bg-card">
                            ...
                            <div class="border-t border-border p-4">
                                <p>ValidTrack employs bank-level security measures including encryption at rest and in
                                    transit, secure access controls, and regular security audits. Your data is stored in
                                    secure, compliant data centers, and we never share your information with third
                                    parties.</p>
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border border-border bg-card">
                            ...
                            <div class="border-t border-border p-4">
                                <p>Yes, ValidTrack is built for team collaboration. You can add team members with
                                    different roles such as Admin, Manager, or Viewer, and control what each role can
                                    access or modify within the system.</p>
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border border-border bg-card">
                            ...
                            <div class="border-t border-border p-4">
                                <p>Yes! We offer a completely free plan for small teams, and you can upgrade to our paid
                                    plans at any time. No credit card is required to get started, and you can cancel
                                    anytime.</p>
                            </div>
                        </div>
                    </div>
        ...
        <section id="pricing" class="py-24">
            <div class="container mx-auto px-4">
                <div class="mb-16 text-center">
                    <span
                        class="mb-4 inline-block rounded-full bg-primary/20 px-3 py-1 text-sm font-medium text-primary">Pricing</span>
                    <h2 class="mb-4 text-3xl font-bold tracking-tight md:text-4xl">Simple Pricing That Scales With You
                    </h2>
                    <p class="mx-auto max-w-2xl text-lg text-muted-foreground">
                        Choose the plan that fits your organization's needs, with flexible options for teams of all
                        sizes.
                    </p>
                </div>
                ...
                <div class="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-3">
                    ...
                    <div
                        ...
                        <ul class="mb-8 space-y-3">
                            <li class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 h-5 w-5 text-primary"
                    ...
                    <!-- Pro Plan -->
                    <div
                        class="flex flex-col rounded-xl border border-primary bg-card p-6 shadow-md transition-all hover:shadow-lg">
                        <div class="mb-2">
                            <span class="rounded-full bg-primary/20 px-3 py-1 text-xs font-medium text-primary">Most
                                Popular</span>
                        </div>
        ...
        <section class="relative overflow-hidden py-24">
            ...
            <div class="relative z-10 container mx-auto px-4 text-center">
                <div class="mx-auto max-w-3xl">
                    <span
                        class="mb-4 inline-block rounded-full bg-primary/20 px-3 py-1 text-sm font-medium text-primary">Why
                        Teams Choose ValidTrack</span>
                    <h2 class="mb-4 text-3xl font-bold tracking-tight md:text-4xl">Your Compliance Hub — Simple, Secure,
                        Reliable</h2>
                    <p class="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground">
                        Built for Compliance Teams, HR Managers, and Procurement Officers to streamline document
        ...
        <footer class="border-t border-border py-12">
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 gap-8 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="#features"
                                    class="text-muted-foreground transition-colors hover:text-primary">Universal
                                    Document Tracking</a></li>
                            <li><a href="#features"
                                    class="text-muted-foreground transition-colors hover:text-primary">Automated Expiry
                                    Reminders</a></li>
                            <li><a href="#features"
                                    class="text-muted-foreground transition-colors hover:text-primary">Compliance
                                    Dashboard</a></li>
                            <li><a href="#features"
                                    class="text-muted-foreground transition-colors hover:text-primary">Full Audit
                                    Logs</a></li>
                            <li><a href="#features"
                                    class="text-muted-foreground transition-colors hover:text-primary">Team
                                    Management</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="#demo"
                                    class="text-muted-foreground transition-colors hover:text-primary">Product Demo</a>
                            </li>
                            <li><a href="#pricing"
                                    class="text-muted-foreground transition-colors hover:text-primary">Pricing</a></li>
                            <li><a href="#faq"
                                    class="text-muted-foreground transition-colors hover:text-primary">FAQ</a></li>
                            <li><a href="#use-cases"
                                    class="text-muted-foreground transition-colors hover:text-primary">Use Cases</a>
                            </li>
                        </ul>
                    </div>

                    <div>
                        <h3 class="mb-3 font-semibold">Company</h3>
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">About
                                    Us</a></li>
                            <li><a href="#"
                                    class="text-muted-foreground transition-colors hover:text-primary">Contact</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Privacy
                                    Policy</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Terms of
                                    Service</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="#"
                                    class="text-muted-foreground transition-colors hover:text-primary">Documentation</a>
                            </li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">API
                                    Reference</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Help
                                    Center</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Blog</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="mt-8 flex flex-col items-center justify-between border-t border-border pt-8 md:flex-row">
                    <div class="text-sm text-muted-foreground">&copy; {{ new Date().getFullYear() }} ValidTrack. All
                        rights reserved.</div>
