...
const features = ref([
    {
        ...
        description: 'Monitor document statuses with intuitive color-coded indicators and expiry timelines at a glance',
    ...
    },
    {
        ...
        description: 'Get alerts before critical documents expire, track revision history, and securely store your compliance files',
        icon: 'M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z',
    },
    {
        title: 'Comprehensive Activity Logs',
        description: 'Track every change with detailed audit trails showing who did what and when, ensuring accountability and transparency',
    ...
    },
    {
        ...
        description: 'Automated notification system that alerts stakeholders when documents are approaching expiration dates',
...
<template>
    ...
    <div class="flex min-h-screen flex-col bg-background text-foreground">
        ...
        <header class="sticky top-0 z-40 w-full border-b border-border/40 bg-background/80 backdrop-blur-sm">
            <div class="container mx-auto flex items-center justify-between px-4 py-4">
                ...
                <nav class="hidden items-center space-x-6 md:flex">
                    ...
                    <a href="#stats" class="text-sm font-medium text-foreground/80 transition-colors hover:text-primary">Results</a>
                </nav>
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col items-center gap-12 md:flex-row">
                    <div class="space-y-8 md:w-1/2">
                        ...
                        >
                            Never Miss a <span class="text-primary">Compliance</span> Deadline Again
                        </h1>
                        ...
                        >
                            ValidTrack's advanced activity logging and document management system gives you complete visibility into your compliance
                            status, with smart reminders before critical documents expire.
                        </p>
                    ...
                    <div :class="['translate-x-4 opacity-0 transition-all delay-300 duration-700 md:w-1/2', { 'translate-x-0 opacity-100': loaded }]">
        ...
        <!-- Features Section -->
        <section id="features" class="bg-secondary/20 py-24">
            <div class="container mx-auto px-4">
                <div class="mb-16 text-center">
                    <span class="mb-4 inline-block rounded-full bg-primary/20 px-3 py-1 text-sm font-medium text-primary">Features</span>
                    <h2 class="mb-4 text-3xl font-bold tracking-tight md:text-4xl">Stay Compliant With Powerful Tools</h2>
                    <p class="mx-auto max-w-2xl text-lg text-muted-foreground">
                        Comprehensive monitoring with detailed activity logs and document tracking to eliminate compliance gaps.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                    <div
                        ...
                        :key="index"
                        :class="[
                            'group translate-y-4 rounded-xl border border-border bg-card p-6 opacity-0 shadow-sm transition-all duration-500 hover:border-primary/20 hover:shadow-md',
                            { 'translate-y-0 opacity-100': loaded },
                        ]"
        ...
        <!-- Activity Logs Highlight Section -->
        <section class="relative overflow-hidden py-24">
            <div class="container mx-auto px-4">
                <div class="flex flex-col items-center gap-12 md:flex-row">
                    <div class="space-y-6 md:w-1/2">
                        <span class="inline-block rounded-full bg-primary/20 px-3 py-1 text-sm font-medium text-primary">New Feature</span>
                        <h2 class="text-3xl font-bold tracking-tight md:text-4xl">Complete Audit Trail With Activity Logs</h2>
                        <p class="text-lg text-muted-foreground">
                            Our new activity logging system tracks every change across your organization. Know exactly who did what and when, with
                            detailed before-and-after comparisons for all document updates.
                        </p>
                        <ul class="space-y-3">
                            <li class="flex items-start gap-2">
                                ...
                                <span>Track creation, updates, and deletion of all records</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <span>Search and filter activity by user, action type, or target</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <span>Generate audit reports for compliance reviews</span>
                            </li>
                        </ul>
                        <div>
                            <Link
                                ...
                                class="inline-flex items-center rounded-md bg-primary px-5 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90"
                            >
                                View Activity Logs
                    ...
                    <div class="md:w-1/2">
                        <div class="relative overflow-hidden rounded-xl border border-border shadow-lg">
                            ...
                            <div class="absolute right-0 bottom-0 left-0 p-6">
                                <div class="rounded-lg border border-border bg-card/95 p-4 shadow-lg backdrop-blur-sm">
                                    <div class="mb-3 flex items-center justify-between">
                                        <h3 class="font-medium">Recent Activity</h3>
                                        <span class="text-xs text-muted-foreground">Today</span>
                                    </div>
                                    <div class="space-y-3">
                                        <div class="flex items-center gap-3 rounded-md p-2 hover:bg-accent/10">
                                            <div class="flex h-8 w-8 items-center justify-center rounded-full bg-green-100">
                                                <span class="text-xs text-green-700">JD</span>
                                            </div>
                                            <div>
                                                <p class="text-sm"><span class="font-medium">John Doe</span> created a new document</p>
                                                <p class="text-xs text-muted-foreground">5 minutes ago</p>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-3 rounded-md p-2 hover:bg-accent/10">
                                            <div class="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100">
                                                <span class="text-xs text-blue-700">AS</span>
                                            </div>
                                            <div>
                                                <p class="text-sm"><span class="font-medium">Alice Smith</span> updated vendor information</p>
        ...
        <section class="relative overflow-hidden py-24">
            ...
            <div class="relative z-10 container mx-auto px-4 text-center">
                <div class="mx-auto max-w-3xl">
                    <h2 class="mb-4 text-3xl font-bold tracking-tight md:text-4xl">Ready to Transform Your Compliance Process?</h2>
                    <p class="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground">
                        Join organizations that trust ValidTrack to maintain compliance and eliminate the stress of tracking critical documents.
                    </p>
                ...
                <div class="grid grid-cols-1 gap-8 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Activity Logs</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Document Management</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Smart Reminders</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Compliance Dashboard</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Documentation</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">API Reference</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Help Center</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Blog</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">About Us</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Contact</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Privacy Policy</a></li>
                            <li><a href="#" class="text-muted-foreground transition-colors hover:text-primary">Terms of Service</a></li>
                        </ul>
                    </div>
                </div>
