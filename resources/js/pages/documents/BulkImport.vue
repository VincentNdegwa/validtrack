                    ...
                    <form @submit.prevent="submitForm" class="space-y-6">
                        <div class="grid gap-4 md:grid-cols-3">
                            <div class="space-y-2">
                                ...
                                <Select id="bulk_subject" v-model="bulkSubject" @change="applyBulkSubject">
                            ...
                            <div class="space-y-2">
                                ...
                                <Select id="bulk_document_type" v-model="bulkDocumentType" @change="applyBulkDocumentType">
                            ...
                            <div class="space-y-2">
                                ...
                                <Select id="bulk_status" v-model="bulkStatus" @change="applyBulkStatus">
                        ...
                        <div class="space-y-4">
                            <div>
                                <Button type="button" variant="outline" @click="addRecord" :disabled="records.length >= 10">
                            ...
                            <div v-for="(record, index) in records" :key="index" class="space-y-4 rounded-lg border p-4">
                                <div class="flex items-center justify-between">
                                    <h4 class="font-medium">Document {{ index + 1 }}</h4>
                                    <Button variant="ghost" size="icon" @click="removeRecord(index)">
                                        <X class="h-4 w-4" />
                                    </Button>
                                </div>
                                ...
                                <div class="grid gap-4 md:grid-cols-3">
                                    <div class="space-y-2">
                                        ...
                                        <Select :id="'subject_' + index" v-model="record.subject_id">
                                            <option value="">Select a subject</option>
                                            <option v-for="subject in subjects" :key="subject.id" :value="subject.id">
                                                {{ subject.name }}
                                            </option>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Select :id="'document_type_' + index" v-model="record.document_type_id">
                                            <option value="">Select a type</option>
                                            <option v-for="type in documentTypes" :key="type.id" :value="type.id">
                                                {{ type.name }}
                                            </option>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Select :id="'status_' + index" v-model="record.status">
                                            <option value="1">Active</option>
                                            <option value="2">Pending Review</option>
                                            <option value="3">Expired</option>
                                            <option value="0">Inactive</option>
                                ...
                                <div class="grid gap-4 md:grid-cols-2">
                                    <div class="space-y-2">
                                        ...
                                        <Input :id="'issue_date_' + index" type="date" v-model="record.issue_date" />
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Input :id="'expiry_date_' + index" type="date" v-model="record.expiry_date" :min="record.issue_date" />
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Input :id="'file_' + index" type="file" @change="(e) => handleFileChange(e, index)" />
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Textarea :id="'notes_' + index" v-model="record.notes" rows="2" />
                                </div>
                            </div>
                        </div>
...
const isValidForSubmit = computed(() => {
    ...
    return records.value.every((record) => record.subject_id && record.document_type_id && record.file && record.issue_date && record.status);
});
