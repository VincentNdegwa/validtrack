...
import { ref } from 'vue';
import { type Subject, type DocumentType, type Document } from '@/types/models';
          ...
          <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div class="space-y-2">
              ...
              <div v-else class="mt-2 text-sm text-muted-foreground">
                Using existing file (leave empty to keep current file)
              </div>
              ...
              <div v-if="filePreview" class="mt-4 max-h-32 overflow-hidden rounded-md border border-border">
                <img v-if="getFileType(filePreview) === 'image'" :src="filePreview" alt="File Preview" class="h-auto max-w-full object-contain" />
