...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center justify-center p-4 bg-background">
        <div class="w-full max-w-2xl rounded-xl border border-border bg-card p-6 shadow-lg transition-shadow duration-300 hover:shadow-xl">
            <div class="mb-6 text-center">
                ...
                <div v-if="Object.keys(form.errors).length > 0" class="mt-4 rounded-lg border border-destructive/20 bg-destructive/10 p-3 text-left">
                    <div class="flex items-start">
                        <svg class="h-5 w-5 flex-shrink-0 text-destructive" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <form @submit.prevent="submit" class="space-y-6">
                            ...
                            >
                                <div class="flex items-center">
                                    <div class="flex flex-col">
                                        ...
                                        <span v-if="docType.required" class="text-xs text-destructive font-medium">Required</span>
                                ...
                                <div>
                                    ...
                                    <span 
                                        v-else
                                        class="rounded-full bg-amber-200 px-2.5 py-1 text-xs font-medium text-amber-800 shadow-sm"
                                    >
                                        Pending
                                    </span>
                                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input
                            ...
                            required
                        />
                        <div v-if="form.errors.verification_code" class="absolute right-2 top-1/2 -translate-y-1/2 text-destructive">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div class="space-y-2">
                        <label for="issue_date" class="block text-sm font-medium">
                            Issue Date <span class="text-destructive">*</span>
                        </label>
                        <input
                            id="issue_date"
                ...
                <div class="space-y-2">
                    ...
                    >
                        <div v-if="!filePreview" class="flex flex-col items-center justify-center text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="mb-2 h-10 w-10 text-muted-foreground/70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div v-else class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="text-sm font-medium truncate max-w-[180px]">{{ form.file?.name }}</p>
                            ...
                            <button
                                type="button"
                                @click="clearFile"
                                class="rounded-full bg-muted p-1.5 text-muted-foreground hover:bg-muted/80 hover:text-destructive transition-colors duration-200"
                            >
                        ...
                        <input id="file" ref="fileInputRef" type="file" @change="onFileChange" class="absolute inset-0 h-full w-full opacity-0 cursor-pointer" />
                    </div>
