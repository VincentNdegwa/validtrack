        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <Card class="col-span-1 md:col-span-2">
                    ...
                    <CardContent>
                        <div v-if="!role.permissions || role.permissions.length === 0" class="py-4 text-center text-muted-foreground">
                        ...
                        <div v-else class="space-y-4">
                            <div class="flex flex-wrap gap-2">
                                <div
                                    ...
                                    :key="permission.id"
                                    class="flex items-center rounded-md bg-muted px-3 py-1.5 text-sm"
                                >
                                    {{ permission.display_name || permission.name }}
                                    <span
                                        v-if="permission.company_id === null"
                                        class="ml-2 rounded-full bg-blue-100 px-2 py-0.5 text-xs text-blue-800 dark:bg-blue-900 dark:text-blue-200"
                                    >
                                        global
                                    </span>
                                </div>
                ...
                <Card class="col-span-1 md:col-span-3">
                    ...
                    <CardContent>
                        <div v-if="!role.users || role.users.length === 0" class="py-4 text-center text-muted-foreground">
