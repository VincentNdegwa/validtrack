...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            ...
            <div v-if="!props.currentPlan" class="rounded-lg p-6 bg-muted/30">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm">
                            <p>This user doesn't have an active subscription. Assign a plan to enable premium features.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <Card class="lg:col-span-2">
                    <CardHeader>
                        <CardTitle class="flex items-center gap-2">
                            <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <CardContent>
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-muted-foreground">{{ props.currentPlan.billing_plan?.description
                                    }}</p>
                            </div>
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <span
                                            ...
                                            props.currentPlan.status.charAt(0).toUpperCase() +
                                            props.currentPlan.status.slice(1) : '' }}
                                        </span>
                                    </div>
                                </div>
                        ...
                        <ul class="space-y-3">
                            <li v-for="feature in planFeatures" :key="feature.id" class="flex items-start space-x-3">
                                <div class="mt-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-primary/10">
                                    <svg class="h-4 w-4 text-primary" xmlns="http://www.w3.org/2000/svg"
        ...
        <Dialog :open="showModal" @update:open="(val) => !val && closeModal()">
            <DialogContent class="sm:max-w-[700px] md:max-w-[800px] lg:max-w-3/4 max-h-[95vh] overflow-y-auto">
                <DialogHeader>
                ...
                <div class="py-4">
                    <form @submit.prevent="assignPlan">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex justify-center">
                                <div class="inline-flex rounded-md shadow-sm" role="group">
                                    <button type="button" @click="form.billing_cycle = 'monthly'" :class="[
                                    ...
                                    <button type="button" @click="form.billing_cycle = 'yearly'" :class="[
                                            'px-4 py-2 text-sm font-medium border',
                        ...
                        <div class="grid gap-4 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
                            <div v-for="plan in props.plans" :key="plan.id" @click="form.plan_id = plan.slug" :class="[
                                ...
                                <!-- Selected badge -->
                                <div v-if="form.plan_id === plan.slug"
                                    ...
                                    <div class="border-t pt-4">
                                        ...
                                        <ul class="space-y-2 text-sm">
                                            <li v-for="feature in plan.features" :key="feature.id"
                                                ...
                                                <svg class="mr-2 h-4 w-4 text-primary"
                                                ...
                                                <span>
                                                    ...
                                                    <span class="font-medium">
                                                        {{ feature.pivot?.value === '-1' ? 'Unlimited' :
                                                        feature.type === 'boolean' ? (feature.pivot?.value === '1' ?
                                                        'Yes' : 'No') :
                                                        feature.pivot?.value }}
                                                    </span>
                                                </span>
                ...
                <DialogFooter class="bottom-0 z-10 bg-background pt-4 mt-4 border-t">
        ...
        <Dialog :open="showCancelDialog" @update:open="(val) => !val && closeCancelDialog()">
            <DialogContent class="sm:max-w-[425px]">
                <DialogHeader>
                    <DialogTitle class="flex items-center gap-2">
                        <svg class="h-5 w-5 text-destructive" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="py-4">
                    ...
                    <div class="rounded-md bg-destructive/10 p-4 text-sm">
                        <div class="flex">
                            <div class="flex-shrink-0">
                                <svg class="h-5 w-5 text-destructive" xmlns="http://www.w3.org/2000/svg"
                ...
                <DialogFooter>
                    ...
                    <Button variant="destructive" @click="cancelPlan" :disabled="form.processing">
                        Cancel Subscription
                    </Button>
                </DialogFooter>
            </DialogContent>
