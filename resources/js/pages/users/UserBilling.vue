...
import { BillingFeature, type BillingPlan } from '@/types/models';
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
                            ...
                            <div class="grid grid-cols-1 gap-4 rounded-lg border p-4 sm:grid-cols-2 md:grid-cols-3">
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        >
                                            {{ props.currentPlan.status ? props.currentPlan.status.charAt(0).toUpperCase() + props.currentPlan.status.slice(1) : '' }}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-muted-foreground">
                                            {{ formatDate(props.currentPlan.current_period_start) }} to 
                                    ...
                                    <div class="border-t pt-4">
                                        ...
                                        <ul class="space-y-2 text-sm">
                                            <li v-for="feature in plan.features" :key="feature.id" class="flex items-center">
                                                <svg class="mr-2 h-4 w-4 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                                                </svg>
                                                <span>
                                                    {{ feature.name }}:
        ...
        <Dialog :open="showCancelDialog" @update:open="(val) => !val && closeCancelDialog()">
            <DialogContent class="sm:max-w-[425px]">
                ...
                <div class="py-4">
                    <p class="mb-4">
                        Are you sure you want to cancel this subscription? The user will lose access to premium features when the current billing period ends.
                    </p>
