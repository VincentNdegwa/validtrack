    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div
            ...
            <div class="absolute top-0 right-0 h-20 w-20">
                <div
                    class="absolute top-0 right-0 h-full w-full bg-gradient-to-bl from-rose-500 to-rose-600 -rotate-45 transform origin-top-right">
                </div>
            </div>
            ...
            @if (isset($plan))
                <div
                    class="bg-slate-50 dark:bg-slate-700/50 p-5 rounded-lg border border-slate-200 dark:border-slate-600/50 mb-8 shadow-sm">
                    <div class="flex justify-between items-start">
                        <div>
                            <h2 class="text-lg font-semibold text-slate-700 dark:text-slate-200 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="h-5 w-5 mr-2 text-rose-500 dark:text-rose-400" viewBox="0 0 20 20"
                                    fill="currentColor">
                        ...
                        <div
                            class="bg-gradient-to-r from-rose-500 to-rose-600 text-white px-3 py-1 rounded-full text-xs font-semibold shadow-sm">
                            {{ $plan->billing_cycle }}
                        </div>
                    </div>

                    <div
                        class="mt-6 bg-white dark:bg-slate-800 rounded-md p-4 border border-slate-200 dark:border-slate-600 shadow-sm">
            ...
            <div class="text-center mt-8">
                <p class="text-sm text-slate-400 dark:text-slate-500">
                    By subscribing, you agree to our <a href="#"
                        class="text-rose-500 hover:text-rose-600 dark:text-rose-400 dark:hover:text-rose-300 underline">Terms</a>
                    and
                    <a href="#"
                        class="text-rose-500 hover:text-rose-600 dark:text-rose-400 dark:hover:text-rose-300 underline">Privacy
                        Policy</a>.
                </p>
            </div>
        </div>
        <div
            ...
            <div class="absolute top-0 right-0 h-20 w-20">
                <div
                    class="absolute top-0 right-0 h-full w-full bg-gradient-to-bl from-emerald-500 to-emerald-600 -rotate-45 transform origin-top-right">
                </div>
            </div>
            ...
            <div class="flex justify-center my-6">
                <div
                    class="w-20 h-20 bg-emerald-100 dark:bg-emerald-900/30 rounded-full flex items-center justify-center shadow-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-emerald-500 dark:text-emerald-400"
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-slate-500 dark:text-slate-400 mt-2">Thank you for subscribing to the {{ $plan->name }}
                    Plan.</p>
            </div>
